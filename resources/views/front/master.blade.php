...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .mki-login-client-btn {
                ...
                box-shadow: 0 8px 18px rgba(194, 152, 107, 0.15);
            }

            .mki-login-client-btn:hover {
                color: #fff;
                background: #9f7448;
                border-color: #9f7448;
            }
    ...
    <body>
        ...
        <script>
            ...
            var OPTIONAL_GEO_SUBMIT_BUDGET_MS = 3500;
            ...
            var resolveScanCoordinates = function() {
                return new Promise(function(resolve, reject) {
                    if (!navigator.geolocation) {
                        reject('Browser Anda tidak mendukung akses lokasi. Verifikasi akan memakai IP perangkat.');
                        return;
                    }
                        ...
                        requestBrowserPosition(geolocationOptions)
                            ...
                            .then(function(position) {
                                if (!position || !position.coords) {
                                    reject('Lokasi tidak terbaca. Verifikasi akan memakai IP perangkat.');
                                    return;
                                }
                                ...
                                if (!Number.isFinite(latitude) || !Number.isFinite(longitude)) {
                                    reject('Koordinat lokasi tidak valid. Verifikasi akan memakai IP perangkat.');
                                    return;
                                }
                                ...
                                if (
                                    ...
                                    reject('Akurasi lokasi masih rendah. Verifikasi akan memakai IP perangkat.');
                                    return;
                                }
                            ...
                            .catch(function() {
                                reject('Izin lokasi tidak diberikan. Verifikasi akan memakai IP perangkat.');
                            });
                    };
            ...
            $("#idForm").submit(function(e) {
                ...
                if (!hasScanCoordinates()) {
                    setSubmitLoading(true);
                    showVerificationLoading("Mencoba membaca lokasi perangkat. Jika izin tidak diberikan, sistem memakai IP.");

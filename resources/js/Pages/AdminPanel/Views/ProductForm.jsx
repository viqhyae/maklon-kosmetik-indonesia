    ...
    const renderSpecField = (field, forceFullWidth = false) => {
        ...
        return (
            <div className="mt-0 md:mt-0 pb-20">
                ...
                {isCategoryModalOpen && (
                    <div
                        className="admin-modal-backdrop fixed inset-0 z-[200] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in"
                        onClick={() => setIsCategoryModalOpen(false)}
                    >
                        <div
                            className="admin-modal-panel bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col h-[85vh] sm:h-[70vh] animate-in zoom-in-95"
                            onClick={e => e.stopPropagation()}
                        >
                            {/* Modal Header & Search */}
                            <div className="admin-modal-header p-4 sm:p-5 border-b border-slate-100 flex items-center gap-3 bg-slate-50">
